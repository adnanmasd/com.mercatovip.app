...
<f7-page name="home" tabs hide-toolbar-on-scroll :page-content="false">
    ...
    <f7-toolbar tabbar labels id="mainToolbar" :class="this.$theme.md ? 'color-black' : ''" bottom-md>
        <a href="/" class="tab-link" data-route-tab-id="hometab"><i class="icon fa fa-home"></i>{{$t('tabbar.home.title')}}</a>
        <a href="/cart/" class="tab-link" data-route-tab-id="carttab"><i class="icon fa fa-shopping-cart"><span v-if="cart.total_product_count" class="badge color-red">{{cart.total_product_count}}</span></i>{{$t('tabbar.cart.title')}}</a>
        <a href="/profile/" class="tab-link" data-route-tab-id="profiletab"><i class="icon material-icons md-only">account_box</i>
        <i class="icon f7-icons ios-only">person</i>{{$t('tabbar.profile.title')}}</a>
        ...
        <f7-list>
            ...
            <f7-list-group v-else>
                <f7-list-item link="/login/" :title="$t('home.sideBar.login')">
                    <div slot="media"><i v-if="this.$theme.ios" class='f7-icons'>login</i><i v-if="this.$theme.md" class='material-icons'>account_circle</i></div>
                </f7-list-item>
            </f7-list-group>
        </f7-list>
        ...
        <f7-list>
            <f7-list-group>
                ...
                <f7-list-item link="/contact" panel-close :title="$t('home.sideBar.contactus.title')">
                    <div slot="media" v-if="theme.ios"><i class='icon f7-icons'>email</i></div>
                    <div slot="media" v-if="theme.md"><i class='icon material-icons'>alternate_email</i></div>
                </f7-list-item>
