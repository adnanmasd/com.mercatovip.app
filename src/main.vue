...
<template>
  ...
  <div id="app" :dir="direction">
    ...
    <f7-view url="/" :main="true" id="main-view" class="ios-edges"></f7-view>

    <f7-popup id="welcomePopup" v-if="firstVisit === 'true'" opened>
      <f7-swiper
        :params="{allowTouchMove:false,effect:'slide',watchSlidesProgress: true}"
        ...
        <f7-swiper-slide class="welcome-slider">
          <f7-block class="text-color-black">
            <f7-row>
              ...
              <f7-col width="100">
                <f7-list>
                  <f7-list-item radio title="English" @click="nextSlide()"></f7-list-item>
                  <f7-list-item radio title="عربي" @click="changeToAr()"></f7-list-item>
                </f7-list>
              </f7-col>
            </f7-row>
          </f7-block>
            ...
            <f7-row>
              ...
              <f7-col width="100" style="padding : 2em">
                <f7-button
                  ...
                  color="black"
                  fill
                  :text="$t('welcome.last.shopnow.title')"
                  close-popup="#welcomePopup"
                  v-on:click="onExitWelcome"
                ></f7-button>
              </f7-col>
            </f7-row>
          </f7-block>
